...
functions for [model selection](#modelSelect) based on AIC or BIC.
Last but not the least, the demonstration of estimation and plotting methods
for [baseline rate function](#baseRate) and mean cumulative function (MCF) are
given, which includes [sample MCF](#sampleMcf) and [estimated MCF](#rateRegMcf)
...
or Lawless and Nadeau method [@lawless1995some].
